...
choices = get_choices() # calling get_choices function which returns dictionary.
result = get_winners(choices["player"], choices["computer"]) # sending disctionary value to the function
